...
export const technicalQuestions = {
    ...
    Creative: [
        {
            id: 1,
            text: "Which color mix creates Green?",
            options: [
                { text: "Red + Blue", correct: false },
                { text: "Blue + Yellow", correct: true },
                { text: "Red + Yellow", correct: false },
                { text: "White + Black", correct: false },
            ],
        },
        {
            id: 2,
            ...
            options: [
                { text: "The study of maps", correct: false },
                { text: "The art of arranging type", correct: true },
                { text: "Ancient writing", correct: false },
                { text: "Photography techniques", correct: false },
            ],
        },
        {
            id: 3,
    ...
    Business: [
        {
            id: 1,
            text: "What implies 'ROI'?",
            options: [
                { text: "Rate of Inflation", correct: false },
                { text: "Return on Investment", correct: true },
                { text: "Risk of Inquiry", correct: false },
                { text: "Real Office Income", correct: false },
            ],
        },
        {
            id: 2,
            text: "A SWOT analysis includes Strengths, Weaknesses, Opportunities, and...?",
            options: [
                { text: "Tasks", correct: false },
                { text: "Threats", correct: true },
                { text: "Teams", correct: false },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "To manufacture products", correct: false },
                { text: "To promote and sell products", correct: true },
                { text: "To calculate taxes", correct: false },
            ],
        },
    ],
    Healthcare: [
        ...
        {
            id: 2,
            text: "What is the normal human body temperature approx?",
            options: [
                { text: "96°C", correct: false },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "Central Pulse Regulation", correct: false },
                { text: "Control Pressure Rate", correct: false },
                { text: "Cardio Pure Recovery", correct: false },
            ],
        },
    ],
    Government: [
        {
            id: 1,
            text: "Who creates laws in a democracy?",
            options: [
                { text: "The Police", correct: false },
                { text: "The Parliament/Legislature", correct: true },
                { text: "The Judges", correct: false },
                { text: "The Military", correct: false },
            ],
        },
        {
            id: 2,
            text: "What is a public sector job?",
            options: [
                { text: "Working for a private company", correct: false },
                { text: "Working for the government", correct: true },
                { text: "Self-employment", correct: false },
                { text: "Freelancing", correct: false },
            ],
        },
        {
            id: 3,
            text: "Diplomacy typically involves:",
            options: [
                { text: "International relations", correct: true },
...
export const aptitudeQuestions = [
    ...
    },
    {
        ...
        options: [
            ...
            { text: "She isn't like apples.", correct: false },
        ],
    },
    {
        id: 4,
